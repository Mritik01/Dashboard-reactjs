...
// import logo-ct-dark from 'src\Components\assets\images\logo-ct-dark.png';
        ...
        <aside className="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
            <div className="sidenav-header">
                ...
                <a className="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank" rel="noreferrer">
                    <img src={require('./assets/images/logo-ct-dark.png')} className="navbar-brand-img h-100" alt="main_logo"></img>
            ...
            <div className="sidenav-footer mx-3 ">
                ...
                <a href="https://www.creative-tim.com/learning-lab/bootstrap/license/argon-dashboard" target="_blank" rel="noopener noreferrer" className="btn btn-dark btn-sm w-100 mb-3">Documentation</a>
